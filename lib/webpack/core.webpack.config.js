...
exports.default = exports.packageJSON = exports.addConfig = exports.addPlugin = exports.addLoader = void 0;
...
var addConfig = function addConfig(key, config) {
  return R.over(R.lensProp(key), R.append(config));
};
